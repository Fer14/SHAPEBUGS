...
class SHAPEBUG:
    ...
    def setlocation(self,x,y):
        self.x = x
        self.y = y
        if is_inside_figure((self.x,self.y)):
            self.set_state("moving_inside")
    ...
    def move_forward(self):
        ...
        if ((self.get_state() == "moving_inside") and (not is_inside_figure((self.x+x,self.y+y)))):
            self.set_state('end')
    ...
    def update_believed_location(self):
        ...
        for neighbor in newrobot:
            ...
            if ((neighbor.get_location() != self.get_location()) and (neighbor.get_believed_location() != self.get_believed_location())):
                if ((dist(neighbor.get_location(),self.get_location()) < 40) and (dist(neighbor.get_location(),self.get_location()) > 0)):

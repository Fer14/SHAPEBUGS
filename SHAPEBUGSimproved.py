...
class SHAPEBUG:
    ...
    def move_forward(self):
        ...
        if ((self.get_state() == "moving_inside") and (not point_inside_rec(300,300,Rect_x,Rect_y,(self.x+x),(self.y+y)))):
            self.set_state('end')
    ...
    def update_believed_location(self):
        ...
        for neighbor in newrobot:
            if neighbor.get_location() != self.get_location():
                if dist(neighbor.get_location(),self.get_location()) < 40:
    ...
    for event in pygame.event.get():
        ...
        if m[0]==1 and not click:
            if point_inside_rec(B.x,B.y, B.width, B.height,x,y):
                ...
                '''newrobot.append(SHAPEBUG("start",99,300+3*20,(Rect_y+336)+0*20,(300,Rect_y+300),False))
                newrobot.append(SHAPEBUG("start",99,300+3*20,(Rect_y+336)+1*20,(300,Rect_y+300),False))
                newrobot.append(SHAPEBUG("start",99,300+0*20,(Rect_y+336)+3*20,(300,Rect_y+300),False))
                newrobot.append(SHAPEBUG("start",99,300+1*20,(Rect_y+336)+3*20,(300,Rect_y+300),False))
                newrobot.append(SHAPEBUG("start",99,300+2*20,(Rect_y+336)+3*20,(300,Rect_y+300),False))'''
